...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for View CLASS_COURSE
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "SYSTEM"."CLASS_COURSE" ("ID_CLASS", "DATES", "NAME", "ID_COURSE") AS 
  select cl.ID_CLASS, cl.DATES, cl.NAME, c.ID_COURSE
from class cl inner join access_class_eval ac on 
(cl.id_class = ac.id_class) inner join course c on
(ac.id_course = c.id_course)
;
--------------------------------------------------------
--  DDL for View STUDENT_COURSE
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "SYSTEM"."STUDENT_COURSE" ("ID_COURSE", "DIFFICULTY", "START_TIME", "END_TIME", "LANGUAGE", "NAME", "ID_USER") AS 
  select c.ID_COURSE, c.DIFFICULTY, c.START_TIME, c.END_TIME, c.LANGUAGE, c.NAME, u.ID_USER
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "SYSTEM"."TEXTS_COURSE" ("ID_TEXTS", "NAME", "AUTHOR", "ISBN", "ID_COURSE") AS 
  select t.ID_TEXTS, t.reference as name, t.author, t.ISBN, c.ID_COURSE
from texts  t inner join access_texts at on 
(t.id_texts = at.id_texts) inner join course c on
(at.id_course = c.id_course)
;
--------------------------------------------------------
--  DDL for View WORKSHOP_COURSE
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "SYSTEM"."WORKSHOP_COURSE" ("ACTIVITY", "CLUE", "ID_WORKSHOP", "ID_COURSE") AS 
  select w.ACTIVITY, w.CLUE, w.ID_WORKSHOP, c.ID_COURSE
from workshop w inner join access_workshop aw on 
(w.id_workshop = aw.ID_WORKSHOP) inner join course c on
(aw.ID_COURSE = c.id_course)
;
--------------------------------------------------------
...
REM INSERTING into SYSTEM.CLASS_COURSE
SET DEFINE OFF;
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('1',to_timestamp('01/05/17 11:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'nosesupreme','1');
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('2',to_timestamp('15/05/17 04:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'hatequilt','2');
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('3',to_timestamp('21/05/17 01:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'complainbite','4');
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('4',to_timestamp('05/06/17 03:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'inscribecreep','3');
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('5',to_timestamp('20/05/17 09:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'sapvoracious','5');
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('6',to_timestamp('31/05/17 12:30:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'delaytray','2');
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('7',to_timestamp('14/06/17 06:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'nutdisgusting','1');
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('8',to_timestamp('20/06/17 09:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'aboriginalpen','2');
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('9',to_timestamp('01/07/17 11:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'electricconsider','5');
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('10',to_timestamp('11/07/17 02:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'pulleducation','4');
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('11',to_timestamp('07/06/17 05:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'mindlesscalendar','3');
Insert into SYSTEM.CLASS_COURSE (ID_CLASS,DATES,NAME,ID_COURSE) values ('12',to_timestamp('30/06/17 01:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'volatilecontrast','2');
REM INSERTING into SYSTEM.STUDENT_COURSE
SET DEFINE OFF;
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('1','1',to_date('11/05/17','DD/MM/RR'),to_date('11/05/17','DD/MM/RR'),'ENG','JAVA','1');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('1','1',to_date('11/05/17','DD/MM/RR'),to_date('11/05/17','DD/MM/RR'),'ENG','JAVA','2');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('2','3',to_date('14/05/17','DD/MM/RR'),to_date('14/05/17','DD/MM/RR'),'ESP','SCRUM ','3');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('1','1',to_date('11/05/17','DD/MM/RR'),to_date('11/05/17','DD/MM/RR'),'ENG','JAVA','4');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('2','3',to_date('14/05/17','DD/MM/RR'),to_date('14/05/17','DD/MM/RR'),'ESP','SCRUM ','5');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('1','1',to_date('11/05/17','DD/MM/RR'),to_date('11/05/17','DD/MM/RR'),'ENG','JAVA','6');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('2','3',to_date('14/05/17','DD/MM/RR'),to_date('14/05/17','DD/MM/RR'),'ESP','SCRUM ','7');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('1','1',to_date('11/05/17','DD/MM/RR'),to_date('11/05/17','DD/MM/RR'),'ENG','JAVA','8');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('2','3',to_date('14/05/17','DD/MM/RR'),to_date('14/05/17','DD/MM/RR'),'ESP','SCRUM ','9');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('3','4',to_date('10/05/17','DD/MM/RR'),to_date('10/05/17','DD/MM/RR'),'ENG','C++','10');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('4','5',to_date('11/05/17','DD/MM/RR'),to_date('11/05/17','DD/MM/RR'),'GER','HASKEL','1');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('5','1',to_date('05/05/17','DD/MM/RR'),to_date('05/05/17','DD/MM/RR'),'FRA','SQL','2');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('4','5',to_date('11/05/17','DD/MM/RR'),to_date('11/05/17','DD/MM/RR'),'GER','HASKEL','3');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('4','5',to_date('11/05/17','DD/MM/RR'),to_date('11/05/17','DD/MM/RR'),'GER','HASKEL','4');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('5','1',to_date('05/05/17','DD/MM/RR'),to_date('05/05/17','DD/MM/RR'),'FRA','SQL','5');
Insert into SYSTEM.STUDENT_COURSE (ID_COURSE,DIFFICULTY,START_TIME,END_TIME,LANGUAGE,NAME,ID_USER) values ('1','1',to_date('11/05/17','DD/MM/RR'),to_date('11/05/17','DD/MM/RR'),'ENG','JAVA','5');
REM INSERTING into SYSTEM.TEXTS_COURSE
SET DEFINE OFF;
Insert into SYSTEM.TEXTS_COURSE (ID_TEXTS,NAME,AUTHOR,ISBN,ID_COURSE) values ('1','birthsensesloppypenitentocean','Jane O. Raper','ABC-abc-1234','1');
Insert into SYSTEM.TEXTS_COURSE (ID_TEXTS,NAME,AUTHOR,ISBN,ID_COURSE) values ('2','skatehategreasycoordinatedlaborer','Audrey C. Harrah','0123-4567','5');
Insert into SYSTEM.TEXTS_COURSE (ID_TEXTS,NAME,AUTHOR,ISBN,ID_COURSE) values ('3','bloodybombjamwoozyquiver','Kristen A. Lorenzo','1234567890','4');
Insert into SYSTEM.TEXTS_COURSE (ID_TEXTS,NAME,AUTHOR,ISBN,ID_COURSE) values ('4','smokesmothercelebrateowloffbeat','Amy R. Ontiveros','ABC-1234','3');
Insert into SYSTEM.TEXTS_COURSE (ID_TEXTS,NAME,AUTHOR,ISBN,ID_COURSE) values ('5','sleetscarecrowwastedeadagree','Andrew S. Shackelford','Aa-1234','2');
Insert into SYSTEM.TEXTS_COURSE (ID_TEXTS,NAME,AUTHOR,ISBN,ID_COURSE) values ('6','entertainingscreamjuicyunarmedforgetful','Harley C. Hocking','ABC-1234-/+','5');
Insert into SYSTEM.TEXTS_COURSE (ID_TEXTS,NAME,AUTHOR,ISBN,ID_COURSE) values ('7','spuriousgroupwalkoverflowdaffy','Shirley D. Cabrales','123456789','4');
Insert into SYSTEM.TEXTS_COURSE (ID_TEXTS,NAME,AUTHOR,ISBN,ID_COURSE) values ('8','colorremoveslayinsectvie','Alonso L. Marks','101234567890','2');
REM INSERTING into SYSTEM.WORKSHOP_COURSE
SET DEFINE OFF;
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('applessitevasivesleeplegal','withdrawtail','1','1');
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('sagobscenecreammotivateapatheticraggedpocket','blossomstand','2','2');
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('incandescentfeathercollarconfusedbreakfastkeygrindignorantletbelong','ajarengrave','3','5');
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('giganticgodlycloverholidaydeclare','organizefriction','4','4');
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('impulseaftermathsquealingmushysanctionleafstormy','kickcloudy','5','3');
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('titlehumdrumornamentinhabitapprovaldirectpoutairplane','honorableguide','6','2');
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('pluckyorangesupplycountspray','glowset','7','4');
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('forcecleavechickenpushyrenouncedizzy','infestruthless','8','5');
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('crookedsoneatabletirepet','difficultblack-and-white','9','3');
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('foldjumbledowlcrazysweet','hard-to-finddoctor','10','1');
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('impulseaftermathsquealingmushysanctionleafstormy','kickcloudy','5','1');
Insert into SYSTEM.WORKSHOP_COURSE (ACTIVITY,CLUE,ID_WORKSHOP,ID_COURSE) values ('impulseaftermathsquealingmushysanctionleafstormy','kickcloudy','5','1');
...
Insert into SYSTEM.ACCESS_COURSE (ID_USER,ID_COURSE,ID_ACCESS,ACCESS_TIME) values ('5','1','16',to_timestamp('16/05/17 02:12:51,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'));
...
Insert into SYSTEM.ACCESS_WORKSHOP (ID_WORKSHOP,AW_ID,ID_COURSE,ACCESS_TIME) values ('5','11','1',to_date('16/05/17','DD/MM/RR'));
Insert into SYSTEM.ACCESS_WORKSHOP (ID_WORKSHOP,AW_ID,ID_COURSE,ACCESS_TIME) values ('5','12','1',to_date('16/05/17','DD/MM/RR'));
...
SET DEFINE OFF;
Insert into SYSTEM.USUARIO (ID_USER,USERNAME,PASSWORD,NAME_USER,EMAIL_USER) values ('1','mmoral','121','mmoral27@eafit.edu.co','Miguel');
...
Insert into SYSTEM.USUARIO (ID_USER,USERNAME,PASSWORD,NAME_USER,EMAIL_USER) values ('11','manfran','ball','Paul','Vaso');
Insert into SYSTEM.USUARIO (ID_USER,USERNAME,PASSWORD,NAME_USER,EMAIL_USER) values ('12','jademosi','hola','James','jademosieafit.edu.co');
...
/
--------------------------------------------------------
--  DDL for Procedure EDIT_USER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."EDIT_USER" 
(
  USER_ID IN NUMBER 
...
/
--------------------------------------------------------
--  DDL for Procedure REGISTER_COURSE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SYSTEM"."REGISTER_COURSE" 
(
  USER_ID IN NUMBER 
, COURSE_ID IN NUMBER 
) AS 
